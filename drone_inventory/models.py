...
class DroneSchema(ma.Schema):
    class Meta:   #if there is any field iterable, put in class Meta to find group
...
# drone_1
# a_dict = {}
# for fields in drone_schema.Meta.fields: #for everything in fields, look at every Drone
...
# car = Car()   
    ...
    #iterates through ouor fields and adds them to a dictionary
    #drone_1
    #{
    #   'id': drone_1.id,
    #   'name': drone_1.name,
